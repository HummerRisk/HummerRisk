  ...
  <div>
    ...
    <el-row type="flex" justify="space-between" align="middle">
      ...
      <span>
        ...
        <table-adv-search-menu :condition.sync="condition" @search="search" @list="list" @menu="menu" v-if="isCombine"/>
      </span>
    </el-row>
  </div>
...
import TableAdvSearchMenu from '@/business/components/common/components/search/TableAdvSearchMenu';
/* eslint-disable */
  export default {
    name: "TableHeader",
    components: {TableAdvSearchMenu, TableSearchBar, TableButton},
    props: {
      title: {
        type: String,
        default() {
