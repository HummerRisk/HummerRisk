<template>
  <span class="adv-search-bar">
    ...
    <el-button icon="el-icon-more" size="small" @click="list"></el-button>
    <el-button icon="el-icon-menu" size="small" @click="menu" style="margin: 0;"></el-button>
