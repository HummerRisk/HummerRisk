        ...
        <el-row type="flex" justify="center" align="middle">
          ...
          <el-row type="flex" justify="center" align="middle">
            ...
            <div class="metric-box">
              <div class="value">{{ content.critical }}</div>
              <div class="name">{{ $t('sbom.critical') }}</div>
            </div>
            <div style="width: 40px"></div>
            <i class="circle warning"/>
            <div class="metric-box">
              <div class="value">{{ content.high }}</div>
              <div class="name">{{ $t('sbom.high') }}</div>
            </div>
            <div style="width: 40px"></div>
            <i class="circle primary"/>
            <div class="metric-box">
              <div class="value">{{ content.medium }}</div>
              <div class="name">{{ $t('sbom.medium') }}</div>
            </div>
            <div style="width: 40px"></div>
            <i class="circle success"/>
            <div class="metric-box">
              <div class="value">{{ content.low }}</div>
              <div class="name">{{ $t('sbom.low') }}</div>
            </div>
            <div style="width: 40px"></div>
            <i class="circle info"/>
            <div class="metric-box">
              <div class="value">{{ content.unknown }}</div>
              <div class="name">{{ $t('sbom.unknown') }}</div>
            </div>
          </el-row>
        </el-row>
      </div>
        ...
        series: [
          {
            ...
            data: [
              {value: this.content.critical},
              {value: this.content.high},
              {value: this.content.medium},
              {value: this.content.low},
              {value: this.content.unknown},
            ]
          }
        ]
      };
