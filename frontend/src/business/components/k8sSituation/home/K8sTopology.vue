            ...
            <el-col :span="3" style="cursor:pointer;">
              ...
              <el-card class="box-card-right2 hr-card-index-1">
                <div class="text item-left">
                  <el-radio v-model="radio" label="critical" style="color: #FFFFFF">{{ 'Critical: ' }} {{ k8sImage.critical }}</el-radio>
                </div>
              </el-card>
              <el-card class="box-card-right2 hr-card-index-2">
                <div class="text item-left">
                  <el-radio v-model="radio" label="high" style="color: #FFFFFF">{{ 'High: ' }} {{ k8sImage.high }}</el-radio>
                </div>
              </el-card>
              <el-card class="box-card-right2 hr-card-index-3">
                <div class="text item-left">
                  <el-radio v-model="radio" label="medium" style="color: #FFFFFF">{{ 'Medium: ' }} {{ k8sImage.medium }}</el-radio>
                </div>
              </el-card>
              <el-card class="box-card-right2 hr-card-index-4">
                <div class="text item-left">
                  <el-radio v-model="radio" label="low" style="color: #FFFFFF">{{ 'Low: ' }} {{ k8sImage.low }}</el-radio>
                </div>
              </el-card>
              <el-card class="box-card-right2 hr-card-index-5">
                <div class="text item-left">
                  <el-radio v-model="radio" label="unknown" style="color: #FFFFFF">{{ 'Unknown: ' }} {{ k8sImage.unknown }}</el-radio>
                </div>
              </el-card>
            </el-col>
          </el-row>
