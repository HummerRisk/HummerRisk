...
export default {
  ...
  system_parameter_setting: {
    ...
    message: {
      ...
      end_scan: '扫描结束',
      notes: '注：只有账号整体扫描可以收到安全合规扫描通知！单个规则扫描或部分扫描不发送安全合规扫描通知。',
  ...
  server: {
    ...
    one_download: '下载模板',
    one_upload: '上传列表',
    server_search: '搜索虚拟机分组',
    all_server: '全部虚拟机分组',
    server_name: '虚拟机名称',
    server_user_name: '用户名',
    server_status: '虚拟机状态',
    server_group_name: '虚拟机分组名称',
    server_group_create: '创建虚拟机分组',
    server_group_rename: '修改虚拟机分组名称',
    i18n_hr_create_success: '创建成功',
    i18n_hr_update_success: '编辑成功',
    delete_confirm: '确认删除 ',
    success: '校验成功',
    ...
    description: '描述',
    last_modified: '最后更新时间',
    result_list: '虚拟机扫描结果列表',
    result: '虚拟机规则扫描结果',
    result_status: '扫描结果状态',
    search_by_name: '根据虚拟机名称搜索',
    validate: '校验',
  },
  image: {
    image_setting: '镜像配置',
  ...
  package: {
    package_setting: '软件包配置',
    package_setting_list: '软件包配置列表',
    package_scan: '软件包扫描',
  ...
  vuln: {
    vuln_setting: '漏洞扫描',
    vuln_settings: '漏洞扫描设置',
    vuln_settings_list: '漏洞扫描设置列表',
    create: '创建漏洞扫描配置',
    update: '更新漏洞扫描配置',
    vuln_rule: '漏洞扫描规则',
    vuln_rule_list: '漏洞扫描规则列表',
    create_rule: '创建漏洞扫描规则',
    vuln_result: '漏洞扫描结果',
    quartz_task: '漏洞扫描定时任务',
    quartz_task_list: '漏洞扫描定时任务列表',
    statistical_analysis: '漏洞扫描统计分析',
    vuln_info: '漏扫信息',
    vuln_result_list: '漏洞扫描结果列表',
    name: '漏扫配置名称',
    platform: '漏洞扫描引擎',
    status: '状态',
    add: '新增',
