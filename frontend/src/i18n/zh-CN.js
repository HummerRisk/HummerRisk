...
export default {
  ...
  resource: {
    ...
    report_detail: '报告详情',
    risk_point: '风险点',
    resource_result_score: '检测评分(不合规资源/资源总数)',
    discover_risk: '发现风险',
    no_risk: '无风险',
    scene_name: '场景名称',
  ...
  task: {
    ...
    gen_report: '生成报告',
    no_selected_task: '没有选择需要生报告的任务，请选择任务!',
    report_desc: 'HummerRisk 是开源的安全检测平台，全面支持云原生，实现对主流公(私)有云资源的安全合规检测、网络漏洞检测、虚拟机安全检测、软件依赖检测、容器镜像检测，支持 Cloud Custodian、Prowler、Nuclei、 Xray 、 Dependency Check 、 Grype 和 Syft 等多种检测引擎，全面满足日常的安全合规检测需要。',
