...
export default {
  ...
  system_parameter_setting: {
    ...
    message: {
      ...
      end_scan: '掃描結束',
      notes: '注：只有賬號整體掃描可以收到安全合規掃描通知！單個規則掃描或部分掃描不發送安全合規掃描通知。 ',
  ...
  server: {
    ...
    description: '描述',
    last_modified: '最後更新時間',
    result_list: '虛擬機掃描結果列表',
    result: '虛擬機規則掃描結果',
    result_status: '掃描結果狀態',
  ...
  package: {
    package_setting: '軟件包配置',
    package_setting_list: '軟件包配置列表',
    package_scan: '軟件包掃描',
  ...
  vuln: {
    vuln_setting: '漏洞掃描',
    vuln_settings: '漏洞掃描設置',
    vuln_settings_list: '漏洞掃描設置列表',
    create: '創建漏洞掃描配置',
    update: '更新漏洞掃描配置',
    vuln_rule: '漏洞掃描規則',
    vuln_rule_list: '漏洞掃描規則列表',
    create_rule: '創建漏洞掃描規則',
    vuln_result: '漏洞掃描結果',
    quartz_task: '漏洞掃描定時任務',
    quartz_task_list: '漏洞掃描定時任務列表',
    statistical_analysis: '漏洞掃描統計分析',
    vuln_info: '漏掃信息',
    vuln_result_list: '漏洞掃描結果列表',
    name: '漏掃配置名稱',
    platform: '漏洞掃描引擎',
    status: '狀態',
    add: '新增',
