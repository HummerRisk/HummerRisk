...
export default {
  ...
  task: {
    ...
    report_desc: 'HummerRisk 是開源的安全檢測平台，全面支持雲原生，實現對主流公(私)有云資源的安全合規檢測、網絡漏洞檢測、主機安全檢測、軟件依賴檢測、容器鏡像檢測，支持 Cloud Custodian、Prowler、Nuclei、 Xray 、 Dependency Check 、 Grype 和 Syft 等多種檢測引擎，全面滿足日常的安全合規檢測需要。 ',
  ...
  fs: {
    file_system: '文件檢測',
    file_system_manage: '文件系統管理',
    fs_rule: '文件系統檢測規則',
    fs_result: '文件系統檢測結果',
    fs_result_list: '文件系統檢測結果列表',
    fs_settings_list: '文件系統列表',
    fs_create: '創建文件系統',
    fs_update: '更新文件系統',
    overview: '文件系統概覽',
    history: '文件系統檢測歷史記錄',
    ...
    size: '文件大小',
    result_details_list: '檢測結果詳情列表',
    project_chart: '文件系統統計',
    fs_chart_top: '文件系統檢測結果統計',
    all_label: '全部文件系統',
  },
};
