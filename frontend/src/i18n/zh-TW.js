...
export default {
  ...
  task: {
    ...
    report_desc: 'HummerRisk 是開源的安全檢測平台，全面支持雲原生，實現對主流公(私)有云資源的安全合規檢測、網絡漏洞檢測、虛擬機安全檢測、軟件依賴檢測、容器鏡像檢測，支持 Cloud Custodian、Prowler、Nuclei、 Xray 、 Dependency Check 、 Grype 和 Syft 等多種檢測引擎，全面滿足日常的安全合規檢測需要。 ',
