...
export default {
  ...
  task: {
    ...
    task_server: 'Virtual machine resources',
    ...
    report_desc: 'HummerRisk is an open-source security detection platform that fully supports cloud native, and implements security compliance detection, network vulnerability detection, virtual machine security detection, software dependency detection, and container image detection for mainstream public (private) cloud resources. Various detection engines such as Cloud Custodian, Prowler, Nuclei, Xray, Dependency Check, Grype and Syft fully meet the needs of daily security compliance detection. ',
