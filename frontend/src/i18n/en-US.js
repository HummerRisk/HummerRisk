...
export default {
  ...
  k8s: {
    ...
    all_label: 'All cloud native accounts',
  ...
  code: {
    code_scan: 'Source code detection',
    code_setting: 'Source configuration',
    code_rule: 'Detection rule',
    code_result: 'Test result',
    code_settings_list: 'Project list',
    ...
    please_choose_code: 'Please choose an item',
  },
  cost: {
