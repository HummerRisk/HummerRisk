...
public class CloudTaskConstants {
    ...
    public final static String[] AWS_RESOURCE_TYPE = {"aws.account","aws.ami","aws.cloudtrail","aws.codebuild","aws.codecommit","aws.codepipeline","aws.config-recorder","aws.config-rule","aws.dynamodb-backup","aws.dynamodb-table","aws.ebs","aws.ec2","aws.ecr","aws.ecs",
            "aws.efs","aws.eks","aws.elasticbeanstalk","aws.elasticache-group","aws.elasticsearch","aws.elb","aws.emr","aws.eni","aws.event-rule","aws.event-rule-target","aws.firehose","aws.glacier","aws.health-event","aws.healthcheck","aws.hostedzone","aws.iam-certificate","aws.iam-group","aws.iam-policy"
            ,"aws.iam-role","aws.iam-user","aws.internet-gateway","aws.iot","aws.kafka","aws.key-pair","aws.kinesis","aws.kms","aws.lambda","aws.launch-config","aws.log-group","aws.message-broker","aws.nat-gateway","aws.network-acl","aws.elastic-ip","aws.network-addr","aws.ops-item","aws.peering-connection","aws.rds","aws.redshift",
            "aws.rest-account","aws.rest-api","aws.route-table","aws.rrset","aws.s3","aws.sagemaker-endpoint","aws.sagemaker-job","aws.secrets-manager","aws.security-group","aws.serverless-app","aws.snowball","aws.sns","aws.ssm-activation","aws.ssm-managed-instance","aws.step-machine","aws.storage-gateway","aws.subnet","aws.transit-attachment","aws.transit-gateway","aws.vpc","aws.vpc-endpoint","aws.vpn-gateway","aws.workspaces"};
    ...
    public final static String[] LB_TYPE = {"aliyun.slb", "huawei.elb", "tencent.clb", "aws.elb", "azure.loadbalancer", "ucloud.ulb", "jdcloud.lb", "ksyun.slb", "baidu.blb", "baidu.app-blb"};
