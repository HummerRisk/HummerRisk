...
public class CloudTaskConstants {
    ...
    public final static String[] AWS_RESOURCE_TYPE = {"aws.account","aws.acm-certificate","aws.alarm","aws.ami","aws.app-elb","aws.app-elb-target-group","aws.asg","aws.backup-plan","aws.backup-vault","aws.batch-compute","aws.batch-definition","aws.cache-cluster","aws.cache-snapshot","aws.cache-subnet-group","aws.cfn","aws.cloud-directory","aws.cloudhsm-cluster","aws.cloudsearch","aws.cloudtrail","aws.codebuild","aws.codecommit","aws.codepipeline","aws.config-recorder","aws.config-rule","aws.customer-gateway","aws.datapipeline","aws.dax","aws.directconnect","aws.directory","aws.distribution","aws.dlm-policy","aws.dms-endpoint","aws.dms-instance","aws.dynamodb-backup","aws.dynamodb-stream","aws.dynamodb-table","aws.ebs","aws.ebs-snapshot","aws.ec2","aws.ec2-reserved","aws.ecr","aws.ecs","aws.ecs-container-instance"
            ,"aws.ecs-service","aws.ecs-task","aws.ecs-task-definition","aws.efs","aws.efs-mount-target","aws.eks","aws.elasticbeanstalk","aws.elasticbeanstalk-environment","aws.elasticache-group","aws.elasticsearch","aws.elb","aws.emr","aws.emr-security-configuration","aws.eni","aws.event-rule","aws.event-rule-target","aws.firehose","aws.fsx","aws.fsx-backup","aws.gamelift-build","aws.gamelift-fleet","aws.glacier","aws.glue-connection","aws.glue-crawler","aws.glue-catalog","aws.glue-database","aws.glue-dev-endpoint","aws.glue-job","aws.glue-classifier","aws.glue-ml-transform","aws.glue-security-configuration","aws.glue-trigger","aws.glue-workflow","aws.glue-table","aws.health-event","aws.healthcheck","aws.hostedzone","aws.hsm","aws.hsm-client","aws.hsm-hapg","aws.iam-certificate","aws.iam-group","aws.iam-policy"
            ,"aws.iam-profile","aws.iam-role","aws.iam-user","aws.identity-pool","aws.internet-gateway","aws.iot","aws.kafka","aws.key-pair","aws.kinesis","aws.kinesis-analytics","aws.kms","aws.kms-key","aws.lambda","aws.lambda-layer","aws.launch-config","aws.launch-template-version","aws.lightsail-db","aws.lightsail-elb","aws.lightsail-instance","aws.log-group","aws.message-broker","aws.ml-model","aws.nat-gateway","aws.network-acl","aws.elastic-ip","aws.network-addr","aws.ops-item","aws.opswork-cm","aws.opswork-stack","aws.peering-connection","aws.qldb","aws.r53domain","aws.rds","aws.rds-cluster","aws.rds-cluster-param-group","aws.rds-cluster-snapshot","aws.rds-param-group","aws.rds-reserved","aws.rds-snapshot","aws.rds-subnet-group","aws.rds-subscription","aws.redshift","aws.redshift-snapshot"
            ,"aws.redshift-subnet-group","aws.redshift-reserved","aws.rest-account","aws.rest-api","aws.rest-resource","aws.rest-stage","aws.rest-vpclink","aws.route-table","aws.rrset","aws.s3","aws.sagemaker-endpoint","aws.sagemaker-endpoint-config","aws.sagemaker-job","aws.sagemaker-model","aws.sagemaker-notebook","aws.sagemaker-transform-job","aws.secrets-manager","aws.security-group","aws.serverless-app","aws.shield-attack","aws.shield-protection","aws.simpledb","aws.snowball","aws.snowball-cluster","aws.sns","aws.sns-subscription","aws.sqs","aws.ssm-activation","aws.ssm-managed-instance","aws.ssm-parameter","aws.step-machine","aws.storage-gateway","aws.streaming-distribution","aws.subnet","aws.support-case","aws.transit-attachment","aws.transit-gateway","aws.user-pool","aws.vpc","aws.vpc-endpoint","aws.vpn-connection","aws.vpn-gateway","aws.waf","aws.waf-regional","aws.workspaces"};
