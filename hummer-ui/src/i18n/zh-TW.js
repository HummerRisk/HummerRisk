...
export default {
  commons: {
    ...
    cloud_native_platform_desc: '混合雲安全治理和容器雲安全檢測',
    cloud_desc: '進入混合雲安全治理',
    cloud_native_desc: '進入容器雲安全檢測',
    cloud_scan_desc: '混合雲安全治理服務可供您評估、審計和評價您的雲資源配置。持續檢測和記錄您的雲資源配置，並支持您自動依據配置需求評估記錄的配置。借助安全治理，您可以查看配置更改以及多雲資源之間的關係、深入探究詳細的資源配置歷史記錄並判斷您的配置在整體上是否符合內部指南中所指定的配置要求。如此一來，您將能夠簡化合規性審計、安全性分析、變更管理和操作故障排除。 ',
  ...
  task: {
    ...
    report_desc: 'HummerRisk 是開源的雲原生安全平台，以非侵入的方式解決雲原生的安全和治理問題。核心能力包括混合雲的安全治理和K8S容器雲安全檢測。全面支持雲原生，滿足日常的安全需要。',
