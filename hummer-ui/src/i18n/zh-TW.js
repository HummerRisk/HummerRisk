...
export default {
  ...
  organization: {
    ...
    integration: {
      ...
      use_tip_two: '保存 Basic Auth 賬號信息後，需要在平台 項目中手動關聯 ID/key',
  ...
  oss: {
    ...
    delete_warning: '對象存儲刪除操作屬於高危操作，會導致雲上資源的清除，平台暫時不允許此操作，如果想開放此功能，請聯繫管理員',
  },
  task: {
    task_setting: '任務編排',
    ...
    report_desc: '平台是開源的雲原生安全平台，以非侵入的方式解決雲原生的安全和治理問題。核心能力包括混合雲的安全治理和雲原生安全檢測。全面支持雲原生，滿足日常的安全需要。 ',
