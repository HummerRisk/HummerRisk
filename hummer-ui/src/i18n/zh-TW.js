...
export default {
  ...
  system_parameter_setting: {
    ...
    message: {
      ...
      end_scan: '檢測結束',
      notes: '注：多雲檢測、漏洞檢測、主機檢測只有賬號整體檢測可以收到安全檢測通知！單個規則檢測或部分檢測不發送通知。 K8s 檢測、部署檢測、鏡像檢測、源碼檢測、文件檢測執行檢測完畢即可發送通知，不涉及規則。 ',
  ...
  rule: {
    ...
    risk_group_sum_project: '(有風險規則組數為 {0})',
    rule_t_project: '規則',
    group_t_project: '規則組',
    risk_rule_t_project: '有風險規則',
    risk_group_t_project: '有風險規則組',
    group_type: '規則組類型',
  },
  resource: {
    have_risk: '有風險',
    ...
    regulation: '風險安全策略',
    regulation_list: '風險安全策略列表',
    total_regulation: '風險安全策略總數',
    risky_regulation: '有風險安全策略',
    risk_free_regulations: '無風險安全策略',
    security_level: '一級標題',
    control_point: '二級標題',
    basic_requirements_for_grade_protection: '風險安全策略描述',
    ...
    requirements_of_the_regulations: '符合風險安全策略要求',
    report_detail: '報告詳情',
    risk_point: '風險點',
  ...
  account: {
    ...
    check_regions: '選中區域',
    checked: '選中',
    checked_note: '選中區域: 保存需要資源同步和執行檢測的區域，默認無選中區域將執行所有區域。 ',
    not_checked: '未選中',
    scan: '檢測',
    creator: '創建人',
    INVALID: '無效',
  ...
  server: {
    ...
    lynis_project: '檢測項',
    lynis_result: '檢測結果',
    lynis_project_name: '檢測項目',
    lynis_result_sum: '檢測數量',
    lynis_risk_sum: '風險數量',
    lynis_result_time: '檢測時間',
  },
  image: {
    image_repo: '鏡像倉庫',
  ...
  STATUS_LOCAL_ONLY: '僅限本地',
  STATUS_MEDIUM: '中',
  STATUS_NON_DEFAULT: '非默認',
  STATUS_NONE: '沒有',
  STATUS_NOT_CONFIGURED: '未配置',
  STATUS_NOT_DISABLED: '未禁用',
  STATUS_NOT_ENABLED: '未啟用',
  STATUS_NOT_FOUND: '沒有找到',
  STATUS_NOT_RUNNING: '沒有運行',
  STATUS_NO_UPDATE: '沒有更新',
  STATUS_NO: '不是',
  STATUS_OFF: '關閉',
  STATUS_OK: '正常',
  STATUS_ON: '開啟',
  STATUS_PARTIALLY_HARDENED: '部分強化',
  STATUS_PROTECTED: '受保護',
  STATUS_RUNNING: '運行',
  STATUS_SKIPPED: '跳過',
  STATUS_SUGGESTION: '建議',
  STATUS_UNKNOWN: '未知',
  STATUS_UNSAFE: '不安全',
  ...
  cloud_topo: {
    ...
    iam_role_resource: 'IAM角色資源',
    ami_resource: '雲機器鏡像',
    cloudtrail_resource: '監管服務',
    emr_resource: '託管大數據平台',
    glacier_resource: '數據存檔服務',
    kms_resource: '密鑰管理託管服務',
    lambda_resource: '計算服務',
    subnet_resource: '子網服務',
    redshift_resource: '雲中數據倉庫服務',
    other_resource: '其他資源',
  ...
  scaning: {
    ...
    init_cloud_group_info: '初始化規則組信息...',
    init_cloud_rule_info: '初始化規則信息...',
    init_env_info: '初始化檢測環境...',
    create_scan_info: '創建檢測任務...',
    create_scan_rule: '創建檢測規則組...',
    create_scan_task: '檢測任務構建...',
    start_scan_task: '開始執行檢測...',
    no_scan: '待檢測',
    no_scan_ing: '未開始檢測',
    start_scan: '正在執行',
    start_scan_ing: '檢測進行中',
    create_end: '創建完成',
    go_scan_result: '進入檢測結果',
    go_result: '進入檢測結果',
  },
};
