...
export default {
  ...
  dashboard: {
    ...
    i18n_hr_apply:'Security Scan Service',
    ...
    rule_report: 'Filter by risk security policy',
  ...
  resource: {
    ...
    resource_result_list: 'List of detection results',
    result_once: 'Manual',
    result_cron: 'timing',
    creator:'Creator',
    copied:'copied',
    ...
    regulation: 'Risk Security Policy',
    regulation_list: 'Risk security policy list',
    total_regulation: 'Total number of risk security policies',
    risky_regulation: 'Risky security policy',
    risk_free_regulations: 'Risk-free security policy',
    security_level: 'Level one title',
    control_point: 'Secondary title',
    basic_requirements_for_grade_protection: 'Risk security policy description',
    ...
    requirements_of_the_regulations: 'Compliance with risk security policy requirements',
  ...
  account: {
    ...
    check_regions: 'Selected area',
    checked: 'Checked',
    checked_note: 'Checked region: Save the region that needs resource synchronization and execution detection. By default, no selected region will execute all regions. ',
  ...
  server: {
    ...
    lynis_project: 'Detection item',
    lynis_result: 'Detection result',
    lynis_project_name: 'Detection project',
    lynis_result_sum: 'Number of tests',
    lynis_risk_sum: 'Risk amount',
    lynis_result_time: 'Detection time',
  },
  image: {
  ...
  system: {
    ...
    open_edition: 'Cloud Native Security',
    copyright: 'Product',
    authorization_date: 'Date',
    forever: 'Forever',
    version_from: 'Direction',
  },
  ...
  cloud_topo: {
    ...
    disk_resource: 'Disk resource',
    iam_resource: 'IAM resource',
    eip_resource: 'Public IP resource',
    ...
    iam_role_resource: 'IAM role resource',
    ami_resource: 'Ami',
    cloudtrail_resource: 'Cloudtrail',
    emr_resource: 'Emr',
    glacier_resource: 'Glacier',
    kms_resource: 'Kms',
    lambda_resource: 'Lambda service',
    subnet_resource: 'Subnet service',
    redshift_resource: 'Redshift',
  ...
  scanning: {
    scanning_log: 'Execute initialization',
    ...
    init_cloud_group_info: 'Initialize rule group information...',
    init_cloud_rule_info: 'Initialize rule information...',
    init_env_info: 'Initialize detection environment...',
    create_scan_info: 'Create detection task...',
    create_scan_rule: 'Create detection rule group...',
    create_scan_task: 'Detection task construction...',
    start_scan_task: 'Start to perform detection...',
    no_scan: 'To be detected',
    no_scan_ing: 'Not started detection',
    start_scan: 'Executing',
    start_scan_ing: 'Detection in progress',
    create_end: 'Creation complete',
    go_scan_result: 'Enter the detection result',
    go_result: 'Enter the test result',
  },
};
