...
export default {
  commons: {
    ...
    login:'Login',
    welcome:'Welcome back, please enter your username and password to log in to Platform',
    username:'Name',
    password:'Password',
  ...
  organization: {
    ...
    integration: {
      ...
      use_tip_two:'After saving the Basic Auth account information, you need to manually associate the ID/key in the Platform project',
  ...
  oss: {
    ...
    delete_warning: 'The object storage deletion operation is a high-risk operation, which will lead to the clearing of resources on the cloud. Platform temporarily does not allow this operation. If you want to open this function, please contact the administrator',
  },
  task: {
