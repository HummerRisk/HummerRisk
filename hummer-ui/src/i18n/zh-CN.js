...
export default {
  ...
  system_parameter_setting: {
    ...
    message: {
      ...
      end_scan: '检测结束',
      notes: '注：多云检测、漏洞检测、主机检测只有账号整体检测可以收到安全检测通知！单个规则检测或部分检测不发送通知。K8s 检测、部署检测、镜像检测、源码检测、文件检测执行检测完毕即可发送通知，不涉及规则。',
  ...
  rule: {
    ...
    suggestion: '优化建议',
    rule_sum: '(共 {0} 规则)',
    rule_sum_project: '共 {0} 规则',
    group_sum_project: '共 {0} 规则组',
    risk_rule_sum_project: '(有风险规则数为 {0})',
    risk_group_sum_project: '(有风险规则组数为 {0})',
    rule_t_project: '规则',
    group_t_project: '规则组',
    risk_rule_t_project: '有风险规则',
    risk_group_t_project: '有风险规则组',
    group_type: '规则组类型',
  },
  resource: {
    have_risk: '有风险',
    ...
    regulation: '风险安全策略',
    regulation_list: '风险安全策略列表',
    total_regulation: '风险安全策略总数',
    risky_regulation: '有风险安全策略',
    risk_free_regulations: '无风险安全策略',
    security_level: '一级标题',
    control_point: '二级标题',
    basic_requirements_for_grade_protection: '风险安全策略描述',
    ...
    requirements_of_the_regulations: '符合风险安全策略要求',
    report_detail: '报告详情',
    risk_point: '风险点',
  ...
  report: {
    ...
    download_project: '下载云账号当次检测合规报告',
    scan_details: '检测报告详情',
    scan_rules: '检测规则列表',
  ...
  cloud_topo: {
    ...
    iam_role_resource: 'IAM角色资源',
    ami_resource: '云机器镜像',
    cloudtrail_resource: '监管服务',
    emr_resource: '托管大数据平台',
    glacier_resource: '数据存档服务',
    kms_resource: '密钥管理托管服务',
    lambda_resource: '计算服务',
    subnet_resource: '子网服务',
    redshift_resource: '云中数据仓库服务',
    other_resource: '其他资源',
