...
export default {
  ...
  organization: {
    ...
    integration: {
      ...
      use_tip_two: '保存 Basic Auth 账号信息后，需要在平台 项目中手动关联 ID/key',
  ...
  oss: {
    ...
    delete_warning: '对象存储删除操作属于高危操作，会导致云上资源的清除，平台暂时不允许此操作，如果想开放此功能，请联系管理员',
  },
  task: {
    task_setting: '任务编排',
    ...
    report_desc: '平台是开源的云原生安全平台，以非侵入的方式解决云原生的安全和治理问题。核心能力包括混合云的安全治理和云原生安全检测。全面支持云原生，满足日常的安全需要。',
