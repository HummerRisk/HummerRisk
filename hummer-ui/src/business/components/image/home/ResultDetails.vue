    ...
    <main-container>
      <el-card class="table-card" v-loading="result.loading">
        ...
        >
          ...
          <el-table-column min-width="110" v-if="checkedColumnNames.includes('installedVersion')" :label="'FixedVersion'" prop="fixedVersion">
          </el-table-column>
...
/* eslint-disable */
  export default {
    ...
    methods: {
      ...
      search () {
        let url = imageResultItemListBySearchUrl + this.currentPage + "/" + this.pageSize;
