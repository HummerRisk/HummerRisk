...
export const RULE_CONFIGS = [RULE_PLUGIN_NAME, RULE_SEVERITY, RULE_RESOURCE_TYPE, RULE_GROUP];
...
export const RESULT_PROJECT_CONFIGS = [PLUGIN_NAME, RESULT_STATUS, CREATOR, CREATE_TIME];
...
export const REPORT_RESULT_CONFIGS = [CREATE_TIME, UPDATE_TIME, CREATOR];
...
export const IMAGE_CONFIGS = [NAME, IMAGE_URL, CREATOR, K8S_RESULT_STATUS, SCAN_TIME, CREATE_TIME, UPDATE_TIME];
export const IMAGE_REPO_CONFIGS = [NAME, REPO, ACCOUNT_STATUS, CREATOR, UPDATE_TIME];
export const IMAGE_REPO_IMAGE_CONFIGS = [REPOSITORY, PATH, TAG];
...
export const K8S_CONFIGS = [NAME, K8S_PLUGIN_NAME, K8S_RESULT_STATUS, SCAN_TIME, UPDATE_TIME, CREATE_TIME, ACCOUNT_STATUS, CREATOR];
...
export const CONFIG_CONFIGS = [NAME, ACCOUNT_STATUS, SCAN_TIME, CREATE_TIME, UPDATE_TIME, K8S_RESULT_STATUS, CREATOR];
...
export const FS_CONFIGS = [NAME, SCAN_TIME, CREATE_TIME, UPDATE_TIME, K8S_RESULT_STATUS, CREATOR];
...
export const K8S_RULE_CONFIGS = [K8S_RULE_PLUGIN_NAME, RULE_SEVERITY, RULE_RESOURCE_TYPE, RULE_GROUP];
