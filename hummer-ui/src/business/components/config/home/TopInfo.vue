    ...
    <el-col :span="4">
      <el-card shadow="always" class="hr-card-index-1">
        <span class="hr-card-data">
          <span class="hr-card-data-digital">{{ topInfo.configs }}</span>
          <span class="hr-card-data-unit"> {{ 'Configs' }}</span>
        </span>
        <span class="hr-card-desc">{{ $t('config.config_settings') }}</span>
      </el-card>
    </el-col>
    <el-col :span="4">
      <el-card shadow="always" class="hr-card-index-2">
        <span class="hr-card-data">
          ...
          <span class="hr-card-data-unit"> {{ 'Critical' }}</span>
        </span>
        <span class="hr-card-desc">{{ $t('code.overview_critical') }}</span>
      </el-card>
    </el-col>
    <el-col :span="4">
...
import {configTopInfoUrl} from "@/api/k8s/config/config";
...
export default {
  ...
  methods: {
    init() {
      this.result = this.$post(configTopInfoUrl, {}, response => {
