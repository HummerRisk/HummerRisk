<template>
  <main-container>
    ...
    <!--History statistics-->
    <el-drawer class="rtl" :title="$t('k8s.vuln_compliance')" :visible.sync="statisticsList" size="85%"
    ...
    <el-drawer class="rtl" :title="$t('k8s.config_compliance')" :visible.sync="configReportList" size="85%"
               :before-close="handleClose" :direction="direction"
               :destroy-on-close="true">
      <div>
    ...
    <!--History kubench-->
    <el-drawer class="rtl" :title="$t('k8s.kubench_compliance')" :visible.sync="kubenchList" size="85%"
               :before-close="handleClose" :direction="direction"
               :destroy-on-close="true">
      <div>
        <el-table border :data="kubenchData" class="adjust-table table-content" @sort-change="sort">
          ...
          <el-table-column min-width="350" :label="'Description'" prop="description" v-slot:default="scope"
                           fixed="right">
            ...
            <el-col :span="24">
              <div class="grid-content bg-purple-light">
                ...
                <span class="grid-content-log-span">
                  <img :src="require(`@/assets/img/platform/${logForm.pluginIcon?logForm.pluginIcon:'k8s.png'}`)"
    ...
    <el-drawer class="rtl" :title="$t('commons.history')" :visible.sync="visibleList" size="85%"
      ...
      <div>
        <el-table border :data="outputListData" class="adjust-table table-content" @sort-change="sort"
          ...
          <el-table-column type="index" min-width="40"/>
          <el-table-column prop="name" :label="$t('k8s.name')" min-width="160" show-overflow-tooltip>
            <template v-slot:default="scope">
              <span>
...
import {K8S_RESULT_CONFIGS} from "@/business/components/common/components/search/search-components";
