...
export const userAllListUrl = "/system/user/list/all";

export const noticeSearchMessageTypeUrl = "/system/notice/search/message/type/";

export const noticeSaveMessageTaskUrl = "/system/notice/save/message/task";
...
export const userSpecialDeleteUrl = "/system/user/special/delete/";

export const userSpecialAddUrl = "/system/user/special/add";

export const userSpecialUpdateUrl = "/system/user/special/update";

export const userSpecialPasswordUrl = "/system/user/special/password";

export const userRoleAllUrl = "/system/user/role/all/";
...
export const editWebhookUrl = "/system/system/edit/webhook";
...
export const userKeyDisableUrl = "/system/user/key/disable/";

export const userKeyActiveUrl = "/system/user/key/active/";

export const userUpdateCurrentUrl = "/system/user/update/current";
