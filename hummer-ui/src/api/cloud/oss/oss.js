...
export const ossAccountsUrl = "/cloud/oss/accounts";
...
export const updateOssUrl = "/cloud/oss/update";

export const ossLogUrl = "/cloud/oss/log/";

export const ossBatchSyncUrl = "/cloud/oss/batch/sync/";
...
export const ossSupportRegionsUrl = "/cloud/bucket/support/regions/";
