...
export const cloudEventListUrl = "/cloud/event/list/";

export const cloudEventGroupListUrl = "/cloud/event/group/list/";

export const cloudEventInsightListUrl = "/cloud/event/insight/list/";

export const cloudEventSyncLogRegionListUrl = "/cloud/event/sync/log/region/list/";

export const cloudEventSyncUrl = "/cloud/event/sync";
