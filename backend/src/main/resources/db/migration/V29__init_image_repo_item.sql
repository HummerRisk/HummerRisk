CREATE TABLE IF NOT EXISTS `image_repo_item` (
    ...
    `project`                    varchar(32)        DEFAULT NULL COMMENT 'project',
    `repository`                 varchar(32)        DEFAULT NULL COMMENT 'repository',
    `tag`                        varchar(32)        DEFAULT NULL COMMENT 'tag',
    `path`                       varchar(256)       DEFAULT NULL COMMENT '镜像地址',
    `size`											 bigint(15)					DEFAULT NULL COMMENT '大小',
