...
CREATE TABLE IF NOT EXISTS `oss_item`
(
    `id`                         varchar(50)         NOT NULL COMMENT 'ID',
    `name`                       varchar(128)        DEFAULT NULL COMMENT '云账号名称',
...
CREATE TABLE IF NOT EXISTS `oss_item_log` (
    `id`                           int(11)             NOT NULL AUTO_INCREMENT,
    `oss_id`                       varchar(50)         DEFAULT NULL COMMENT 'Oss ID',
    `oss_item_id`                  varchar(50)         DEFAULT NULL COMMENT 'Oss item ID',
    `region_id`                    varchar(100)        DEFAULT NULL COMMENT '区域ID',
    `region_name`                  varchar(100)        DEFAULT NULL COMMENT '区域名称',
    `create_time`                  bigint(13)          DEFAULT NULL COMMENT '创建时间',
    ...
    PRIMARY KEY (`id`)
    ) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAUCREATE TABLE IF NOT EXISTS `oss_bucket` (
    `id`                           varchar(50)         NOT NULL COMMENT 'ID',
    ...
    PRIMARY KEY (`id`)
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;LT CHARSET = utf8mb4;
