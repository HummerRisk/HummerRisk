...
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('27.0 AWS Implementation Group 安全检查', 'AWS CIS Implementation Group', 'CIS', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('26.0 AWS 服务目录安全检查', 'AWS Directory Service related security checks', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('25.0 AWS FTR 安全检查', 'AWS Amazon FTR related security checks', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('24.0 AWS Glue 安全检查', 'AWS Glue related security checks', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('23.0 AWS ENS 安全检查', 'AWS ENS Esquema Nacional de Seguridad security checks', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('22.0 AWS SageMaker 安全检查', 'AWS SageMaker related security checks', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('21.0 AWS SOC2 安全检查', 'AWS SOC2 Readiness - ONLY AS REFERENCE', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('20.0 AWS FFIEC 网络安全检查', 'AWS FFIEC Cybersecurity Readiness', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('19.0 AWS EKS 基准检查', 'AWS CIS EKS Benchmark', 'CIS', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('18.0 AWS ISO 27001 安全检查', 'AWS ISO 27001:2013 Readiness', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('17.0 AWS 暴露的网络资源检查', 'AWS Find resources exposed to the internet', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('16.0 AWS 跨账户信任边界', 'AWS Find cross-account trust boundaries', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('15.0 AWS PCI-DSS v3.2.1 安全检查', 'AWS PCI-DSS v3.2.1 Readiness', '最佳实践', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('14.0 AWS Elasticsearch 安全检查', 'AWS Elasticsearch related security checks', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('13.0 AWS RDS 安全检查', 'AWS RDS security checks', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('12.0 AWS API Gateway 安全检查', 'AWS API Gateway security checks', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('11.0 AWS 密钥/密码安全检查', 'AWS Look for keys secrets or passwords around resources', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('10.0 AWS HIPAA 安全检查', 'AWS HIPAA Compliance - ONLY AS REFERENCE', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('9.0 AWS GDPR 安全检查', 'AWS GDPR Readiness - ONLY AS REFERENCE', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('8.0 AWS Forensics 安全检查', 'AWS Forensics Readiness', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('7.0 AWS 所有非 CIS 特定检查', 'AWS Extras - all non CIS specific checks', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('6.0 AWS CIS Level 2', 'AWS CIS Level 2', 'CIS', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('5.0 AWS CIS Level 1', 'AWS CIS Level 1', 'CIS', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('4.0 AWS Networking 安全检查', 'AWS Networking', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('3.0 AWS Monitoring 安全检查', 'AWS Monitoring', '安全合规', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('2.0 AWS Logging 安全检查', 'AWS Logging - CIS', 'CIS', 'hummer-aws-plugin', 1);
INSERT INTO `rule_group` (`name`, `description`, `level`, `plugin_id`, `flag`) VALUES ('1.0 AWS IAM 安全检查', 'AWS Identity and Access Management', '安全合规', 'hummer-aws-plugin', 1);
