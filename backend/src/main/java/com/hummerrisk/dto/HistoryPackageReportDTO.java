...
public class HistoryPackageReportDTO extends HistoryPackageTask {
    ...
    private List<PackageDependencyJsonItemWithBLOBs> packageDependencyJsonItemList;//结果json
    ...
    public List<PackageDependencyJsonItemWithBLOBs> getPackageDependencyJsonItemList() {
        return packageDependencyJsonItemList;
    }

    public void setPackageDependencyJsonItemList(List<PackageDependencyJsonItemWithBLOBs> packageDependencyJsonItemList) {
        this.packageDependencyJsonItemList = packageDependencyJsonItemList;
    }
}
