...
import io.hummerrisk.commons.constants.RoleConstants;
...
import io.hummerrisk.service.UserService;
...
public class UserController {
    ...
    @RequiresRoles(RoleConstants.ADMIN)
    public Pager<List<User>> getUserList(@PathVariable int goPage, @PathVariable int pageSize, @RequestBody io.hummerrisk.controller.request.UserRequest request) {
