package io.hummerrisk.proxy.openstack;
...
import static io.hummerrisk.proxy.openstack.OpenStackUtils.getUserProjects;
...
public class OpenStackRequest extends Request {
    ...
    public OSClientV3 searchOpenStackClientByInstanceId(String instanceId) throws PluginException {
        ...
        List<? extends Project> projects = getUserProjects(osClient);
