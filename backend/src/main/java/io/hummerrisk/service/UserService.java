...
import io.hummerrisk.base.mapper.UserMapper;
import io.hummerrisk.base.mapper.UserRoleMapper;
import io.hummerrisk.base.mapper.ext.ExtUserMapper;
import io.hummerrisk.base.mapper.ext.ExtUserRoleMapper;
import io.hummerrisk.commons.constants.*;
import io.hummerrisk.commons.exception.HRException;
import io.hummerrisk.commons.user.SessionUser;
...
import io.hummerrisk.controller.request.LoginRequest;
import io.hummerrisk.controller.request.member.AddMemberRequest;
import io.hummerrisk.controller.request.member.EditPassWordRequest;
import io.hummerrisk.controller.request.member.QueryMemberRequest;
import io.hummerrisk.controller.request.member.UserRequest;
import io.hummerrisk.controller.request.organization.AddOrgMemberRequest;
import io.hummerrisk.controller.request.organization.QueryOrgMemberRequest;
import io.hummerrisk.dto.UserDTO;
import io.hummerrisk.dto.UserRoleDTO;
import io.hummerrisk.i18n.Translator;
import io.hummerrisk.security.HrUserToken;
...
import static io.hummerrisk.commons.constants.SessionConstants.ATTR_USER;
...
public class UserService {
    ...
    public List<User> getUserListWithRequest(io.hummerrisk.controller.request.UserRequest request) {
