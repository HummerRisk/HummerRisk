...
VALUES ( 'admin', '管理员', 'admin@hummercloud.com', '$2a$10$aTG8nCGRorFhGKgL8BHt9.pesax/ch2aDO/zZMX9U4eSqSgUVEGJ6', '1', unix_timestamp() * 1000, unix_timestamp() * 1000, 'zh-CN', NULL, '666666', 'LOCAL' );
...
VALUES ( 'admin', '系统管理员', '系统管理员', NULL, unix_timestamp() * 1000, unix_timestamp() * 1000 );
