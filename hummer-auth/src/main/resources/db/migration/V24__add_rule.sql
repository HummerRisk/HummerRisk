...
-- Huawei Rule
-- ----------------------------
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('776f0a66-25d4-4aee-bbdc-6f30a2c4652e', 'Huawei GaussDBForNoSQL 实例计费类型检测', 1, 'HighRisk', 'Huawei 检测您账号下 GaussDBForNoSQL 数据库实例计费类型信息，按需视为“合规”，否则视为“不合规”', 'policies:\n    #测您账号下GaussDBForNoSQL数据库实例计费类型信息，按需视为“合规”，否则视为“不合规”\n    - name: huawei-gaussdbfornosql-charge-info\n      resource: huawei.gaussdbfornosql\n      filters:\n        - type: charge-info\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"计费模式:“0”:按需计费/\\\"1\\\":包年包月。\",\"defaultValue\":\"\\\"0\\\"\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('8e50d813-0d65-474c-951a-4abacbf381cc', 'Huawei GaussDBForNoSQL 实例公网访问检测', 1, 'HighRisk', 'Huawei 检测您账号下 GaussDBForNoSQL 实例不允许任意来源公网访问，视为“合规”，否则属于“不合规”', 'policies:\n    # 检测您账号下GaussDBForNoSql实例不允许任意来源公网访问，视为“合规”\n    - name: huawei-gaussdbfornosql-internet-access\n      resource: huawei.gaussdbfornosql\n      filters:\n        - type: internet-access\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"不允许任意来源公网访问\",\"defaultValue\":\"true\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('fcd416f0-e58c-417a-8795-a99748d6f4ce', 'Huawei GaussDBForNoSQL 实例磁盘空间检测', 1, 'HighRisk', 'Huawei 账号下 GaussDBForNoSQL 实例磁盘空间是否已满，未满视为“合规”，否则属于“不合规”', 'policies:\n    # 账号下GaussDBForNoSql实例磁盘空间是否已满，未满视为“合规”，否则属于“不合规”。\n    - name: huawei-gaussdbfornosql-storagefull\n      resource: huawei.gaussdbfornosql\n      filters:\n        - type: storagefull', '[]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('4eed4751-16fc-4827-a3aa-12865b6c5c73', 'Huawei GaussDBForNoSQL 实例网络类型检测', 1, 'HighRisk', 'Huawei 账号下 GaussDBForNoSQL 实例已关联到VPC；视为“合规”', 'policies:\n    # 账号下GaussDBForNoSql实例已关联到VPC；视为“合规”。\n    - name: huawei-gaussdbfornosql-instance-network-type\n      resource: huawei.gaussdbfornosql\n      filters:\n        - type: instance-network-type\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"网络类型\",\"defaultValue\":\"VPC\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('77e50110-e477-4b24-a3c2-a9f5e7e41715', 'Huawei GaussDBForNoSQL 实例高可用状态检测', 1, 'HighRisk', 'Huawei 账号下 GaussDBForNoSQL 实例具备高可用能力，视为“合规”，否则属于“不合规”', 'policies:\n    # 账号下GaussDBForNoSql实例具备高可用能力，视为“合规”，否则属于“不合规”。\n    - name: huawei-gaussdbfornosql-high-availability\n      resource: huawei.gaussdbfornosql\n      filters:\n        - type: high-availability', '[]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('8048b411-967a-47b3-b4f1-d7d7880eb79c', 'Huawei GaussDBForOpenGauss 实例公网访问检测', 1, 'HighRisk', 'Huawei 检测您账号下 GaussDBForOpenGauss 实例不允许任意来源公网访问，视为“合规”，否则属于“不合规”', 'policies:\n    # 检测您账号下GaussDBForOpenGauss实例不允许任意来源公网访问，视为“合规”\n    - name: huawei-gaussdbforopengauss-internet-access\n      resource: huawei.gaussdbforopengauss\n      filters:\n        - type: internet-access\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"不允许任意来源公网访问\",\"defaultValue\":\"true\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('86415c99-3215-4f11-a62b-fa4c7b2ac298', 'Huawei GaussDBForOpenGauss 实例磁盘空间检测', 1, 'HighRisk', 'Huawei 账号下 GaussDBForOpenGauss 实例磁盘空间是否已满，未满视为“合规”，否则属于“不合规”', 'policies:\n    # 账号下GaussDBForOpenGauss实例磁盘空间是否已满，未满视为“合规”，否则属于“不合规”。\n    - name: huawei-gaussdbforopengauss-storagefull\n      resource: huawei.gaussdbforopengauss\n      filters:\n        - type: storagefull', '[]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('1abf0c53-b4ac-4b45-b528-8f47b8d7d533', 'Huawei GaussDBForOpenGauss 实例网络类型检测', 1, 'HighRisk', 'Huawei 账号下 GaussDBForOpenGauss 实例已关联到VPC；视为“合规”', 'policies:\n    # 账号下GaussDBForOpenGauss实例已关联到；视为“合规”。\n    - name: huawei-gaussdbforopengauss-instance-network-type\n      resource: huawei.gaussdbforopengauss\n      filters:\n        - type: instance-network-type\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"网络类型\",\"defaultValue\":\"VPC\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('f393ba0b-23ca-435b-b922-62c77a9437f7', 'Huawei GaussDBForOpenGauss 实例计费类型检测', 1, 'HighRisk', 'Huawei 测您账号下GaussDBForOpenGauss数据库实例计费类型信息，按需视为“合规”，否则视为“不合规”', 'policies:\n    #测您账号下GaussDBForOpenGauss数据库实例计费类型信息，按需视为“合规”，否则视为“不合规”\n    - name: huawei-gaussdbforopengauss-charge-info\n      resource: huawei.gaussdbforopengauss\n      filters:\n        - type: charge-info\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"计费模式:prePaid包年包月/postPaid按需\",\"defaultValue\":\"postPaid\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('86254202-388c-4c55-bba2-a3053c16fe3b', 'Huawei GaussDBForOpenGauss 实例高可用状态检测', 1, 'HighRisk', 'Huawei GaussDBForOpenGauss实例高可用状态检测', 'policies:\n    # 账号下GaussDBForOpenGauss实例具备高可用能力，视为“合规”，否则属于“不合规”。\n    - name: huawei-gaussdbforopengauss-high-availability\n      resource: huawei.gaussdbforopengauss\n      filters:\n        - type: high-availability', '[]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('cc1f97e7-73c5-4f4f-91e9-1155d47ed24e', 'Huawei GaussDB 实例公网访问检测', 1, 'HighRisk', 'Huawei 检测您账号下 GaussDB 实例不允许任意来源公网访问，视为“合规”，否则属于“不合规”', 'policies:\n    # 检测您账号下GaussDB实例不允许任意来源公网访问，视为“合规”\n    - name: huawei-gaussdb-internet-access\n      resource: huawei.gaussdb\n      filters:\n        - type: internet-access\n          value: ${{value}}', '[{\"defaultValue\":\"true\",\"name\":\"不允许任意来源公网访问\",\"key\":\"value\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('c61ae072-e614-47d6-b0ee-07f50360032e', 'Huawei GaussDB 实例磁盘空间检测', 1, 'HighRisk', 'Huawei 账号下 GaussDB 实例磁盘空间是否已满，未满视为“合规”，否则属于“不合规”', 'policies:\n    # 账号下GaussDB实例磁盘空间是否已满，未满视为“合规”，否则属于“不合规”。\n    - name: huawei-gaussdb-storagefull\n      resource: huawei.gaussdb\n      filters:\n        - type: storagefull', '[]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('fa800f05-b7ac-4009-86f9-413d26bbc368', 'Huawei GaussDB 实例网络类型检测', 1, 'HighRisk', 'Huawei 账号下 GaussDB 实例已关联到VPC；视为“合规”', 'policies:\n    # 账号下GaussDB实例已关联到；视为“合规”。\n    - name: huawei-gaussdb-instance-network-type\n      resource: huawei.gaussdb\n      filters:\n        - type: instance-network-type\n          value: ${{value}}', '[{\"defaultValue\":\"VPC\",\"name\":\"实例的网络类型\",\"key\":\"value\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('e1b193de-9b9f-41de-89d5-62a731d2f212', 'Huawei GaussDB 实例计费类型检测', 1, 'HighRisk', 'Huawei 测您账号下 GaussDB 数据库实例计费类型信息，按需视为“合规”，否则视为“不合规”', 'policies:\n    #测您账号下GaussDB数据库实例计费类型信息，按需视为“合规”，否则视为“不合规”\n    - name: huawei-gaussdb-charge-info\n      resource: huawei.gaussdb\n      filters:\n        - type: charge-info\n          value: ${{value}}', '[{\"key\":\"value\",\"name\":\"计费模式:prePaid包年包月/postPaid按需\",\"defaultValue\":\"postPaid\",\"required\":true}]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`) VALUES ('b4620c46-795f-4d13-9139-2055849ec7b9', 'Huawei GaussDB 实例高可用状态检测', 1, 'HighRisk', 'Huawei 账号下 GaussDB 实例具备高可用能力，视为“合规”，否则属于“不合规”', 'policies:\n    # 账号下GaussDB实例具备高可用能力，视为“合规”，否则属于“不合规”。\n    - name: huawei-gaussdb-high-availability\n      resource: huawei.gaussdb\n      filters:\n        - type: high-availability', '[]', 'hummer-huawei-plugin', '华为云', 'fusion.png', concat(unix_timestamp(now()), '001'), '1', 'custodian');
