...
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`, `suggestion`) VALUES ('2d08f729-f869-4b69-8772-41a8d58b5c34', 'Rancher StatefulSet 内存限制检测', 1, 'MediumRisk', '检测 Rancher StatefulSet 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。', 'policies:\n    # 检测 Rancher StatefulSet 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。\n    - name: rancher-stateful-set\n      resource: rancher.stateful-set\n      filters:\n        - type: memory-limit\n          limit_min: ${{value1}}\n          limit_max: ${{value2}}', '[{\"defaultValue\":\"64\",\"name\":\"最小内存限制\",\"key\":\"value1\",\"required\":true},{\"defaultValue\":\"1024\",\"name\":\"最大内存限制\",\"key\":\"value2\",\"required\":true}]', 'hummer-rancher-plugin', 'Rancher', 'rancher.png', concat(unix_timestamp(now()), '004'), 1, 'custodian', NULL);
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`, `suggestion`) VALUES ('c3959d6f-d6c1-49d9-9f16-bd7f8e359667', 'Rancher Pod 内存大小限制检测', 1, 'MediumRisk', '检测 Rancher Pod 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。', 'policies:\n    # 检测 Rancher Pod 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。\n    - name: rancher-pod-memory\n      resource: rancher.pod\n      filters:\n        - type: memory-limit\n          limit_min: ${{value1}}\n          limit_max: ${{value2}}', '[{\"key\":\"value1\",\"name\":\"最小内存限制\",\"defaultValue\":\"64\",\"required\":true},{\"key\":\"value2\",\"name\":\"最大内存限制\",\"defaultValue\":\"1024\",\"required\":true}]', 'hummer-rancher-plugin', 'Rancher', 'rancher.png', concat(unix_timestamp(now()), '004'), 1, 'custodian', NULL);
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`, `suggestion`) VALUES ('c5544cfe-074a-4947-a075-d607dc705837', 'Rancher DaemonSet 内存大小限制检测', 1, 'MediumRisk', '检测 Rancher DaemonSet 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。', 'policies:\n    # 检测 Rancher DaemonSet 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。\n    - name: rancher-daemon-set-memory\n      resource: rancher.daemon-set\n      filters:\n        - type: memory-limit\n          limit_min: ${{value1}}\n          limit_max: ${{value2}}', '[{\"key\":\"value1\",\"name\":\"最小内存限制\",\"defaultValue\":\"64\",\"required\":true},{\"key\":\"value2\",\"name\":\"最大内存限制\",\"defaultValue\":\"1024\",\"required\":true}]', 'hummer-rancher-plugin', 'Rancher', 'rancher.png', concat(unix_timestamp(now()), '004'), 1, 'custodian', NULL);
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`, `suggestion`) VALUES ('cf01ca4c-c87a-4db6-b90a-830f6d1018ea', 'Rancher Deployment 内存限制检测', 1, 'MediumRisk', '检测 Rancher Deployment 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。', 'policies:\n    # 检测 Rancher deployment 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。\n    - name: rancher-deployment-memory\n      resource: rancher.deployment\n      filters:\n        - type: memory-limit\n          limit_min: ${{value1}}\n          limit_max: ${{value2}}', '[{\"key\":\"value1\",\"name\":\"最小内存限制\",\"defaultValue\":\"64\",\"required\":true},{\"key\":\"value2\",\"name\":\"最大内存限制\",\"defaultValue\":\"1024\",\"required\":true}]', 'hummer-rancher-plugin', 'Rancher', 'rancher.png', concat(unix_timestamp(now()), '004'), 1, 'custodian', NULL);
INSERT INTO `rule` (`id`, `name`, `status`, `severity`, `description`, `script`, `parameter`, `plugin_id`, `plugin_name`, `plugin_icon`, `last_modified`, `flag`, `scan_type`, `suggestion`) VALUES ('fe65831e-24b1-4c5b-a08b-e0bae0d3847b', 'Rancher ReplicaSet 内存大小限制检测', 1, 'MediumRisk', '检测 Rancher ReplicaSet 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。', 'policies:\n    # 检测 Rancher ReplicaSet 限制内存大小在64-1024MB，在限制大小范围内视为“合规”，否则视为“不合规”。\n    - name: rancher-replica-set-memory\n      resource: rancher.replica-set\n      filters:\n        - type: memory-limit\n          limit_min: ${{value1}}\n          limit_max: ${{value2}}', '[{\"key\":\"value1\",\"name\":\"最小内存限制\",\"defaultValue\":\"64\",\"required\":true},{\"key\":\"value2\",\"name\":\"最大内存限制\",\"defaultValue\":\"1024\",\"required\":true}]', 'hummer-rancher-plugin', 'Rancher', 'rancher.png', concat(unix_timestamp(now()), '004'), 1, 'custodian', NULL);
