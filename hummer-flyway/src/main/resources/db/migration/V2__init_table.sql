...
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (6, 'hummer-job-prod.yml', 'DEFAULT_GROUP', '# spring配置\nspring:\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PASSWORD}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${HR_MYSQL_HOST}:${HR_MYSQL_PORT}/${HR_MYSQL_DB}?autoReconnect=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false\n    username: ${HR_MYSQL_USER}\n    password: ${HR_MYSQL_PASSWORD}\n  \n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.hummer.job.domain\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:com/hummer/job/mapper/*.xml\n\n# swagger配置\nswagger:\n  title: 定时任务接口文档\n  license: Powered By hummer\n  licenseUrl: https://hummerrisk.com\n', '94bae56ddfc31934e55bcb8739896609', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '定时任务', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (7, 'hummer-cloud-prod.yml', 'DEFAULT_GROUP', '# 混合云    \n# spring配置\nspring: \n  messages:\n    basename: i18n/messages\n    encoding: UTF-8\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PASSWORD}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${HR_MYSQL_HOST}:${HR_MYSQL_PORT}/${HR_MYSQL_DB}?autoReconnect=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false\n    username: ${HR_MYSQL_USER}\n    password: ${HR_MYSQL_PASSWORD}\n\n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.hummer.cloud.domain\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:com/hummer/cloud/mapper/*.xml\n\n# swagger配置\nswagger:\n  title: 混合云接口文档\n  license: Powered By hummerrisk\n  licenseUrl: https://hummerrisk.com\n\n\n', '5d786c886992f6a1d8bc685e8d71795f', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '混合云安全', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (8, 'hummer-k8s-prod.yml', 'DEFAULT_GROUP', '# 云原生    \n# spring配置\nspring: \n  messages:\n    basename: i18n/messages\n    encoding: UTF-8\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PASSWORD}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${HR_MYSQL_HOST}:${HR_MYSQL_PORT}/${HR_MYSQL_DB}?autoReconnect=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false\n    username: ${HR_MYSQL_USER}\n    password: ${HR_MYSQL_PASSWORD}\n\n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.hummer.k8s.domain\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:com/hummer/k8s/mapper/*.xml\n\n# swagger配置\nswagger:\n  title: 云原生接口文档\n  license: Powered By hummerrisk\n  licenseUrl: https://hummerrisk.com\n\n\n', '8cd26d665949104b57e5fa4d9568ab3a', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '云原生安全', 'null', 'null', 'yaml', '', '');
