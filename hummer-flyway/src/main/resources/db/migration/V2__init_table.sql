...
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (2, 'hummer-gateway.yml', 'DEFAULT_GROUP', 'spring:\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PASSWORD}\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n      routes:\n        # 认证中心\n        - id: hummer-auth\n          uri: lb://hummer-auth\n          predicates:\n            - Path=/auth/**\n        # 定时任务\n        - id: hummer-job\n          uri: lb://hummer-job\n          predicates:\n            - Path=/schedule/**\n          filters:\n            - StripPrefix=1\n        # 系统模块\n        - id: hummer-system\n          uri: lb://hummer-system\n          predicates:\n            - Path=/system/**\n          filters:\n            - StripPrefix=1\n        # 混合云模块\n        - id: hummer-cloud\n          uri: lb://hummer-cloud\n          predicates:\n            - Path=/cloud/**\n          filters:\n            - StripPrefix=1\n        # 云原生模块\n        - id: hummer-k8s\n          uri: lb://hummer-k8s\n          predicates:\n            - Path=/k8s/**\n          filters:\n            - StripPrefix=1\n# 安全配置\nsecurity:\n  # 防止XSS攻击\n  xss:\n    enabled: true\n    excludeUrls:\n      - /system/notice\n  # 不校验白名单\n  ignore:\n    whites:\n      - /signout\n      - /language\n', 'a9c796199990b266d8d94b582ce9e4de', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '网关模块', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (3, 'hummer-auth.yml', 'DEFAULT_GROUP', 'spring:\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PASSWORD}\n  # flyway enable\n  flyway:\n    # 启用或禁用 flyway\n    enabled: true\n    # 当迁移时发现目标schema非空，而且带有没有元数据的表时，是否自动执行基准迁移，默认false.\n    baseline-on-migrate: true\n    # 默认脚本加载路径：/db/migration\n    locations: classpath:db/migration\n    # 指定 baseline 的版本号,默认值为 1, 低于该版本号的 SQL 文件, migrate 时会被忽略\n    baseline-version: 0\n    # 字符编码\n    encoding: UTF-8\n    # 迁移时是否校验，默认为 true\n    validate-on-migrate: false\n    # 是否要被替换，默认 true\n    placeholder-replacement: false\n    # metadata 版本控制信息表 默认 flyway_schema_history\n    table: hummer_version\n    # 数据库配置\n    url: jdbc:mysql://${HR_MYSQL_HOST}:${HR_MYSQL_PORT}/${HR_MYSQL_DB}?autoReconnect=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false\n    user: ${HR_MYSQL_USER}\n    password: ${HR_MYSQL_PASSWORD}\n', 'a60ce31eadb4dfc754ef7e353183cb71', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '认证中心', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (4, 'hummer-monitor.yml', 'DEFAULT_GROUP', '# spring\nspring:\n  security:\n    user:\n      name: hummer\n      password: 123456\n  boot:\n    admin:\n      ui:\n        title: HummerRisk服务状态监控\n', 'ab1a38ac49aaf99abc136bb1079f3516', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '监控中心', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (5, 'hummer-system.yml', 'DEFAULT_GROUP', '# spring配置\nspring:\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PASSWORD}\n  datasource:\n    druid:\n      stat-view-servlet:\n        enabled: true\n        loginUsername: admin\n        loginPassword: 123456\n    dynamic:\n      druid:\n        initial-size: 5\n        min-idle: 5\n        maxActive: 20\n        maxWait: 60000\n        timeBetweenEvictionRunsMillis: 60000\n        minEvictableIdleTimeMillis: 300000\n        validationQuery: SELECT 1 FROM DUAL\n        testWhileIdle: true\n        testOnBorrow: false\n        testOnReturn: false\n        poolPreparedStatements: true\n        maxPoolPreparedStatementPerConnectionSize: 20\n        filters: stat,slf4j\n        connectionProperties: druid.stat.mergeSql\\=true;druid.stat.slowSqlMillis\\=5000\n      datasource:\n          # 主库数据源\n          master:\n            driver-class-name: com.mysql.cj.jdbc.Driver\n            url: jdbc:mysql://${HR_MYSQL_HOST}:${HR_MYSQL_PORT}/${HR_MYSQL_DB}?autoReconnect=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false\n            username: ${HR_MYSQL_USER}\n            password: ${HR_MYSQL_PASSWORD}\n          # 从库数据源\n          # slave:\n            # username: \n            # password: \n            # url: \n            # driver-class-name: \n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.hummer.system\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 系统模块接口文档\n  license: Powered By hummer\n  licenseUrl: https://hummerrisk.com', 'ed6d478e92f7ff05c42fd133b2982dbd', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '系统模块', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (6, 'hummer-job.yml', 'DEFAULT_GROUP', '# spring配置\nspring:\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PORT}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${HR_MYSQL_HOST}:${HR_MYSQL_PORT}/${HR_MYSQL_DB}?autoReconnect=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false\n    username: ${HR_MYSQL_USER}\n    password: ${HR_MYSQL_PASSWORD}\n  \n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.hummer.job.domain\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 定时任务接口文档\n  license: Powered By hummer\n  licenseUrl: https://hummerrisk.com\n', '94bae56ddfc31934e55bcb8739896609', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '定时任务', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (7, 'hummer-cloud.yml', 'DEFAULT_GROUP', '# 混合云    \n# spring配置\nspring: \n  messages:\n    basename: i18n/messages\n    encoding: UTF-8\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PORT}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${HR_MYSQL_HOST}:${HR_MYSQL_PORT}/${HR_MYSQL_DB}?autoReconnect=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false\n    username: ${HR_MYSQL_USER}\n    password: ${HR_MYSQL_PASSWORD}\n\n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.hummer.cloud.domain\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 混合云接口文档\n  license: Powered By hummerrisk\n  licenseUrl: https://hummerrisk.com\n\n\n', '5d786c886992f6a1d8bc685e8d71795f', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '混合云安全', 'null', 'null', 'yaml', '', '');
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (8, 'hummer-k8s.yml', 'DEFAULT_GROUP', '# 云原生    \n# spring配置\nspring: \n  messages:\n    basename: i18n/messages\n    encoding: UTF-8\n  redis:\n    host: ${HR_REDIS_HOST}\n    port: ${HR_REDIS_PORT}\n    password: ${HR_REDIS_PORT}\n  datasource:\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://${HR_MYSQL_HOST}:${HR_MYSQL_PORT}/${HR_MYSQL_DB}?autoReconnect=false&useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false\n    username: ${HR_MYSQL_USER}\n    password: ${HR_MYSQL_PASSWORD}\n\n# mybatis配置\nmybatis:\n    # 搜索指定包别名\n    typeAliasesPackage: com.hummer.k8s.domain\n    # 配置mapper的扫描，找到所有的mapper.xml映射文件\n    mapperLocations: classpath:mapper/**/*.xml\n\n# swagger配置\nswagger:\n  title: 云原生接口文档\n  license: Powered By hummerrisk\n  licenseUrl: https://hummerrisk.com\n\n\n', '8cd26d665949104b57e5fa4d9568ab3a', sysdate(), sysdate(), 'nacos', '0:0:0:0:0:0:0:1', '', '', '云原生安全', 'null', 'null', 'yaml', '', '');
